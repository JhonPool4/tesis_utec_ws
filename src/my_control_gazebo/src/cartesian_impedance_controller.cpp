...
// info 	: 	cartesian impedance controller
// =======================================
	...
	class CartesianImpedanceController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
        ...
        public:
			bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
			{
				...
				// Subscribers
				_sub_pose_command = n.subscribe<my_control_gazebo::Pose>("pose_command", 1, &CartesianImpedanceController::poseCommandCB, this);
				// Publishers
